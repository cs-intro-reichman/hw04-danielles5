...
public class ArrCharOps {
    ...
    */
    public static char[] concat(char[] arr1, char[] arr2) {
        ...
        char[] groupedArr = new char[length];
        ...
        for (int j = arr1.length; j < length; j++) {
            groupedArr[j] = arr2[j - arr1.length];
        }
    ...
    public static long hashCode(char[] arr) {
        ...
        for (int i = 0; i < arr.length; i++) {
            ...
            hashCalc += (long)(arr[i] * Math.pow(7, arr.length - 1 - i));
        }
    ...
    public static int compareTo(String str1, String str2) {
        ...
        // Makes sure no String is invalid
        ...
        // If both strings have the same characters and the same length, they are considered equal.
        ...
        // Finds the shorter string/longer string out of the two
        if (str1.length() < str2.length()) {
            shorterString = str1;
            longerString = str2;
        } else {
        ...
        for (int i = 0; i < shorterString.length(); i++) {
            ...
            char letter1 = shorterString.charAt(i);
            char letter2 = longerString.charAt(i);
